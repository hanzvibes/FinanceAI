      ...
      {selectedTransaction && (() => {
        ...
        return <div className={`transaction-receipt ${selectedTransaction.type}`}>
          ...
          <div className="modal-actions receipt-actions">
            <button type="button" className="button ghost" onClick={() => { const transaction = selectedTransaction; setSelectedTransaction(null); setEditingTransaction(transaction); }}>Edit</button>
            <button type="button" className="button ghost danger-link" onClick={() => { const id = selectedTransaction.id; setSelectedTransaction(null); removeTransaction(id); }}>Hapus</button>
